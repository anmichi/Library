...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"test/atcoder/internal_scc.hpp\"\n\n\n\n#include <algorithm>\n\
    #include <utility>\n#include <vector>\n\nnamespace atcoder {\nnamespace internal\
  ...
  verifiedWith: []
documentation_of: test/atcoder/internal_scc.hpp
layout: document
redirect_from:
- /library/test/atcoder/internal_scc.hpp
- /library/test/atcoder/internal_scc.hpp.html
