...
data:
  ...
  bundledCode: "#line 1 \"test/atcoder/internal_math.hpp\"\n\n\n\n#include <utility>\n\
    \nnamespace atcoder {\n\nnamespace internal {\n\n// @param m `1 <= m`\n// @return\
  ...
  verifiedWith: []
documentation_of: test/atcoder/internal_math.hpp
layout: document
redirect_from:
- /library/test/atcoder/internal_math.hpp
- /library/test/atcoder/internal_math.hpp.html
