...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"test/atcoder/segtree.hpp\"\n\n\n\n#include <algorithm>\n\
  ...
  verifiedWith: []
documentation_of: test/atcoder/segtree.hpp
layout: document
redirect_from:
- /library/test/atcoder/segtree.hpp
- /library/test/atcoder/segtree.hpp.html
