...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"test/atcoder/internal_queue.hpp\"\n\n\n\n#include <vector>\n\
  ...
  verifiedWith: []
documentation_of: test/atcoder/internal_queue.hpp
layout: document
redirect_from:
- /library/test/atcoder/internal_queue.hpp
- /library/test/atcoder/internal_queue.hpp.html
