...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"test/atcoder/lazysegtree.hpp\"\n\n\n\n#include <algorithm>\n\
  ...
  verifiedWith: []
documentation_of: test/atcoder/lazysegtree.hpp
layout: document
redirect_from:
- /library/test/atcoder/lazysegtree.hpp
- /library/test/atcoder/lazysegtree.hpp.html
